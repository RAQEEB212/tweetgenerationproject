    ...
    return (
      <Box sx={{ p: 12, pb: 6 }}>
        ...
        <Table sx={{ mb: 6 }}>
          ...
          <TableBody>
            <TableRow>
              <TableCell>Tweet Generation</TableCell>
        ...
        <Grid container>
          <Grid item xs={8} sm={7} lg={9}>
            <Box sx={{ mb: 2, display: 'flex', alignItems: 'center' }}>
              ...
              <Typography variant='body2'>Raqeeb</Typography>
            </Box>

            <Typography variant='body2'>Happy to Deal with you</Typography>
          </Grid>
        ...
        <Typography variant='body2'>
          <strong>Note:</strong> Our team very confident, our service will benifit  you more then you invested
        </Typography>
      </Box>
    )
  } else if (error) {
