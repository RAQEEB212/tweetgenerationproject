        ...
        <DatePickerWrapper>
          <form onSubmit={handleSubmit(onSubmit)} autoComplete='off'>
            ...
            <FormControl fullWidth sx={{ mb: 6 }}>
              ...
              >
                <MenuItem value='Personal Tweet'>Personal Tweet</MenuItem>
                <MenuItem value='Business Tweet'>Business Tweet</MenuItem>
                <MenuItem value='Family Tweet'>Family Tweet</MenuItem>
                <MenuItem value='Holiday Tweet'>Holiday Tweet</MenuItem>
                <MenuItem value='Others Tweet'>Others Tweet</MenuItem>
              </Select>
            </FormControl>
            <Box sx={{ mb: 6 }}>
              <DatePicker
            ...
            />
            <FormControl fullWidth sx={{ mb: 6 }}>
              <InputLabel id='event-guests'>Tags</InputLabel>
              <Select
                multiple
                label='Guests'
                value={values.guests}
              ...
              >
                ...
                <MenuItem value='vecatons'>#vecations</MenuItem>
