...
const defaultColumns = [
  ...
  //   field: 'endDate',
  //   headerName: 'Due Date',
  //   renderCell: ({ row }) => <Typography variant='body2'>{row.endDate}</Typography>
  // },
  // {
  //   flex: 0.1,
  //   minWidth: 90,
  ...
  return (
    <DatePickerWrapper>
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <CardHeader title='Payment status checker' />
            <CardContent>
              <Grid container spacing={6}>
                <Grid item xs={12} sm={6}>
                  <FormControl fullWidth>
                    ...
                    >
                      ...
                      <MenuItem value='Banking Processing'>Banking Processing</MenuItem>
                      <MenuItem value='Payment Reject From Bank'>Payment Reject From Bank</MenuItem>
                    </Select>
                  </FormControl>
                </Grid>
                <Grid item xs={12} sm={6}>
